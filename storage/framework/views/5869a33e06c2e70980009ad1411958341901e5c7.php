...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open([ 'route' => ['admin::admin.update', $admin->id],  'name' => 'administrador', 'method' => 'put' ]); ?>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo Form::text('name', $admin->name, ['class' => 'form-control', 'placeholder' => 'Nome']); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo Form::email('email', $admin->email, ['class' => 'form-control', 'placeholder' => 'Email']); ?>
