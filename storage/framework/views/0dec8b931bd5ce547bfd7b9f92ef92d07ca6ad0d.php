...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open([ 'route' => 'admin::profile.update',  'name' => 'profile', 'method' => 'put' ]); ?>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo Form::email('email', $auth->email, ['class' => 'form-control', 'disabled' => 'disabled', 'placeholder' => 'Email']); ?>
