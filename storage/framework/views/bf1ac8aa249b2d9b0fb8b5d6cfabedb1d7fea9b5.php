...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open([ 'route' => ['admin::plan.update', $plan->id], 'name' => 'specializations', 'method' => 'put' ]); ?>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo Form::text('name', $plan->name, ['class' => 'form-control', 'placeholder' => 'Nome do Plano']); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php echo Form::text('price', $plan->price, ['class' => 'form-control', 'placeholder' => 'Preço']); ?>
