...
<head>
  ...
  <title>Odontolocaliza | <?php echo e(isset($page_title) ? $page_title : "Logar"); ?></title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo e(asset("/bower_components/admin-lte/plugins/iCheck/square/blue.css")); ?>">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo route('home'); ?>"> <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Odontolocaliza"> </a>
  </div>
  <!-- /.login-logo -->
...
<!-- Bootstrap 3.3.5 -->
<script src="<?php echo e(asset("/bower_components/admin-lte/bootstrap/bootstrap/js/bootstrap.min.js")); ?>"></script>
<!-- iCheck -->
