	                        ...
	                        <div class="col-md-12">
	                                            ...
	                                            <tr>
	                                                ...
	                                                <td>
	                                                    <label class="label label-primary">
	                                                        {{ title_case($subscription->plan_name) }} (R$ {{ number_format(($subscription->price_cents / 100), 2, ',', '.') }})
	                                                    </label>
	                                                </td>
	                                            </tr>
	                                            <tr>
	                            ...
	                            <div class="row">
	                                <div class="col-md-6">
	                                    ...
	                                    <form role="form" class="form-sm form-horizontal" method="post" action="{{ route('subscription.update', [ 'id' =>$user->id ]) }}">
	                                            ...
	                                            <div class="form-group">
	                                                <select name="plan" class="form-control">
	                                                	@foreach( $plans as $plan )
		                                                    @if($user->subscription_plan != $plan->identifier)
		                                                        <option value="{{ $plan->identifier }}">{{ title_case($plan->name) }} (R$ {{ number_format(($plan->price), 2, ',', '.') }})</option>
		                                                    @endif
	                                                    @endforeach
	                                                </select>
	                                            </div>
